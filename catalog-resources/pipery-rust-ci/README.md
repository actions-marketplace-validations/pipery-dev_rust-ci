# Pipery Rust CI Component

Reusable GitLab CI/CD component for complete Rust CI pipeline with structured logging.

## Overview

This component provides a complete CI/CD pipeline for Rust projects:
- SAST scanning
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-rust-ci/catalog-resources/pipery-rust-ci@main
...
| RUST_VERSION | 1.70 | Rust runtime version |
